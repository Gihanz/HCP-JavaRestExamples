...
public class Main {
    ...
    static private final  String HCPAuthHeaderKey = "";

    public static void main(String[] args) {
        try {
            String auth = "hcp-ns-auth=" + Utils.getBase64Value("filenet-admin") + ":" + Utils.getMD5Value("mit12345");
...
//    }
    ...
    public static void put(HttpClient client, String auth) throws IOException{
        //specify namespace URL - eg. namespace.tenant.HCP.DOMAIN.com/rest/path
        String url = "https://fileshare.filenet-poc.hcp.dclab.local:443/rest/examples/world4.txt";

        //specify path to file you want to upload(PUT)
        String localFilePath = "C:/Users/gihanli/Downloads/HCPJavaRestExamples-master/HCPJavaRestExamples-master/world.txt";
    ...
    public static void addMetaData(HttpClient client, String auth) throws IOException{
        ...
        String url = "https://fileshare.filenet-poc.hcp.dclab.local:443/rest/fileshare/CONTENT/FN13/FN16/FN18/FN%7BF0D4DB6B-0000-C154-9D83-402E228DBC9D%7D%7B7669F598-119E-47F9-B069-554B3FD2574D%7D-0?" +
                        "type=custom-metadata&annotation=myannotation";
        
        //String url = "https://fileshare.filenet-poc.hcp.dclab.local:443/rest/examples/world.txt?" +
          //      "type=custom-metadata&annotation=myannotation";

        //specify path to file you want to upload(PUT)
        String localFilePath = "C:/Users/gihanli/Documents/eclipse workpace BOC archive/HCPJavaRestExamples/myannotation.xml";
        ...
        request.setEntity(requestEntity);
        //execute PUT request
        String yourJsonString = "{\"index\":\"true\"}";

        //pass the json string request in the entity
        HttpEntity sss = new ByteArrayEntity(yourJsonString.getBytes("UTF-8"));
        request.setEntity(sss);
        HttpResponse response = client.execute(request);
